...
import { FaArrowLeft, FaCheck, FaLeaf, FaEdit, FaCheckCircle } from 'react-icons/fa'
...
const Garden = () => {
  ...
  const features = [
    "Stunning aerial garden photography",
    "Landscape design documentation",
    "Before and after comparisons",
    "Seasonal garden tracking",
    "Property boundary mapping",
    "Custom garden portfolios"
  ]
          ...
          >
            ...
            <VStack spacing={{ base: 6, lg: 4 }} align="start">
              ...
              <MotionHeading
                ...
                textAlign="left"
              >
                Capture Your Garden's Natural Beauty
              </MotionHeading>
              <MotionText
                fontSize={{ base: "lg", md: "xl" }}
                ...
                px={{ base: 0, lg: 0 }}
              >
                Our aerial photography service showcases your garden and landscape designs from unique perspectives, highlighting their natural beauty and architectural elements.
              </MotionText>
            </VStack>
