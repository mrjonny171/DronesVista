...
import { FaArrowLeft, FaCheck, FaCamera, FaEdit, FaCheckCircle } from 'react-icons/fa'
...
const RealEstate = () => {
  ...
  const features = [
    ...
    "Property overview from multiple angles",
    "Highlight key features and surroundings",
        ...
        >
          ...
          >
            ...
            <VStack spacing={{ base: 6, lg: 4 }} align="start">
              ...
              <MotionHeading
                ...
                textAlign="left"
              >
                Showcase Your Properties from Above
              </MotionHeading>
              <MotionText
                fontSize={{ base: "lg", md: "xl" }}
                ...
                px={{ base: 0, lg: 0 }}
              >
                Our aerial photography service provides stunning perspectives of real estate properties, helping agents and sellers showcase their listings in the most compelling way.
              </MotionText>
            </VStack>
          ...
          >
            <MotionImage
              ...
              alt="Real Estate Aerial Photography"
              objectFit="cover"
              w="100%"
              h="100%"
              borderRadius="xl"
