...
import { FaArrowLeft, FaCheck, FaMapMarkedAlt, FaEdit, FaCheckCircle } from 'react-icons/fa'
...
const Mapping = () => {
  ...
  const features = [
    ...
    "Orthomosaic imagery generation",
    "3D terrain modeling",
    "Volume calculations",
    "Progress monitoring",
          ...
          >
            ...
            <VStack spacing={{ base: 6, lg: 4 }} align="start">
              ...
              <MotionHeading
                ...
                textAlign="left"
              >
                Precise Aerial Mapping Solutions
              </MotionHeading>
              <MotionText
                fontSize={{ base: "lg", md: "xl" }}
                ...
                px={{ base: 0, lg: 0 }}
              >
                Our aerial mapping service provides accurate, detailed maps and 3D models for construction, agriculture, and land development projects.
              </MotionText>
            </VStack>
